...
date: "`r Sys.Date()`"
abstract: "Version without adaption of normal curve but with explicit colors of vertical lines."
output: 
    learnr::tutorial:
        progressive: true
        allow_skip: true
...
This chapters could be divided into two part: It beginns with an introduction to the research process: How to start with initial observations, how to generate theories and hypothesis to test the research assumptions?

In this process are may basic notions explained:
...
To check if you are conversant with these notions you could take the [multiple choice test for this chapter](https://studysites.uk.sagepub.com/dsur/study/mcq/Chapter%201/quiz.htm) taken from the student resources of the companion site. Additionally I have filled another [Quiz](#quiz01) into a MC test. These 13 questions are taken the instructor resources at the [SAGE website](https://studysites.uk.sagepub.com/dsur/main.htm).
...
d.normal <- rbeta(10000,5,5)
d.right <-  rbeta(10000,2,5)
d.left <-   rbeta(10000,5,2)
``` 
...
ggplot(histo, aes(value)) +
    ...
    labs(caption = "vertical lines: black = mode, blue = mean, green = median")
